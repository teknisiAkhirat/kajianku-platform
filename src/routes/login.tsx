...
export const Route = createFileRoute("/login")({
  component: LoginPage,
  head: () => ({ meta: [{ title: "Masuk — Teknisi.Akhirat" }] }),
});
...
function LoginPage() {
  ...
  return (
    <AuthShell
      title="Masuk"
      subtitle="Lanjutkan perjalanan dakwah digital Anda."
      footer={
        <>
          Belum punya akun?{" "}
    ...
    >
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        <div className="space-y-2">
          ...
          <Input id="email" type="email" required value={email} onChange={(e) => setEmail(e.target.value)} className="h-11" placeholder="nama@email.com" />
        </div>
        <div className="space-y-2">
